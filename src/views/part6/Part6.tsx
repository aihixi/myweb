        ...
        <div className='part6body'>
          <div className='part6bodyleft'>
            <div className='textinput'>
              <h2>Do a comment</h2>
              <div style={{display: 'flex', alignItems: 'center', columnGap: '16px', background: 'white'}}>
                <IoPersonCircleSharp size={32} />
                <input type="text" placeholder='Name' style={{width: '100%', height: '24px', border: 'none', outline: 'none'}} />
              </div>
              <div style={{display: 'flex', alignItems: 'center', columnGap: '16px', background: 'white'}}>
                <LuMessageSquareCode size={32} />
                <input type="text" placeholder='Message' style={{width: '100%', height: '24px', border: 'none', outline: 'none'}} />
              </div>
              <div>
